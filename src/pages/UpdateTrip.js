...
export default function UpdateTrip() {
    ...
    const UpdateTrip = async (event) => {
        ...
        const values = { date, destination, description, days, rating, user_id, trip_id};
            ...
            <h1>TRIPS</h1>
             ...
             <form onSubmit={UpdateTrip} className="row g-3">
                ...
                <div className="col-md-6">
                    ...
                    <input type="text" name="destination" className="form-control" id="input-destination" placeholder="Choose the place..." required/>
                </div>
                ...
                <div className="col-md-2">
                    ...
                    <input type="text" className="form-control" id="input-lat" disabled/>
                </div>
                <div className="col-md-2">
                    <label htmlFor="inputLon" className="form-label">Lon</label>
                    <input type="text" className="form-control" id="input-lon" disabled/>
                </div>
                <div className="col-12">
